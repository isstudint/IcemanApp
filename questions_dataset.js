...
const QUESTIONS = [
  ...
  },
  {
    "id": "topic11_q3",
    "number": "3",
    "question": "Introductory Info\nCase study -\nThis is a case study. Case studies are not timed separately. You can use as much exam time as you would like to complete each case. However, there may be additional case studies and sections on this exam. You must manage your time to ensure that you are able to complete all questions included on this exam in the time provided.\nOverview -\nGeneral Overview -\nContoso, Ltd. is a consulting company that has a main office in Montreal and branch offices in Seattle and New York.\nEnvironment -\nExisting Environment -\nContoso has an Azure subscription named Sub1 that is linked to an Microsoft Entra ID tenant.\nThe Microsoft Entra ID tenant contains the users shown in the exhibit.\nSub1 contains two resource groups named RG1 and RG2 and the virtual networks shown in the exhibit.\nSub1 contains virtual machines that run Windows Server 2019 as shown in the exhibit.\nNo network security groups (NSGs) are associated to the network interfaces or the subnets.\nSub1 contains the storage accounts shown in the exhibit.\nRequirements -\nPlanned Changes -\nContoso plans to implement the following changes:\n- Create an NSG named NSG1 and associate to VM1.\n- Create an NSG named NSG2 and associate to VNET1/Subnet2.\nTechnical Requirements -\nContoso must meet the following technical requirements:\n- Enable flow logging for IP traffic from VM5 and retain the flow logs for a period of eight months.\n- Use the principle of least privilege.\nQuestion\nYou need to identify which storage account to use for the flow logging of IP traffic from VM5. The solution must meet the retention requirements.\n\nWhich storage account should you identify?",
    "domain": "monitor",
    "choices": [
      "A. storage1",
      "B. storage2",
    ...
    "explanation": "NSG Flow Logging requires a **General Purpose v2 (StorageV2)** storage account located in the **same region** as the target resource. According to the exhibit, **VM5 is in East US**. Among the accounts, **storage2 is the only StorageV2 account located in East US** (storage1 is in West US, storage3 is legacy BlobStorage in East US 2, and storage4 is in Central US). StorageV2 also supports lifecycle management policies to meet the 8-month retention requirement.",
    "correct": 1,
    "type": "pdf",
    "image": "images/case_study_contoso_full.png"
  },
  {
    "id": "topic12_q1",
    "number": "1",
